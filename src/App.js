    ...
    >
      <Router>
        <Layout className="layout">
          ...
          <div
            className="flex flex-col h-[1000px] relative overflow-x-hidden bg-cuanmax bg-no-repeat bg-top"
              ...
              <div>
                <Routes>
                  ...
                  <Route
                    path="/"
                    element={
                      <Navigate to="pool/core/0x874b44da0addd8acfbe018f82aab741b57e176f5" />
                    }
                  />
                </Routes>
              </div>
